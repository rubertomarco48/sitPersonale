function Home() {
    return (
        ...
        <p className="text-center w-full pres text-white text-xl z-50">Oltre alla mia competenza tecnica, ho acquisito un solido bagaglio di abilità relazionali, inclusa la capacità di interagire con clienti e fornitori in modo efficace ed empatico. </p>
        <p className="text-center w-full pres text-white text-xl z-50">La mia esperienza passata mi ha altresì conferito un'ottima capacità nella gestione delle scadenze e delle commesse, competenza che nel settore in cui attualmente opero si rivela essere di vitale importanza.</p>
        <p className="text-center w-full pres text-white text-xl z-50">Guardo al futuro con grande entusiasmo, desideroso di affrontare nuove sfide e continuare a crescere sia come professionista che come individuo.</p>
        <p className="text-center w-full pres text-white text-xl z-50">Sono convinto che il mio mix di determinazione, ambizione e spirito collaborativo continuerà a guidarmi lungo un percorso di successo nell'entusiasmante mondo dello sviluppo informatico.</p>
        </div>
    );
  }
  export default Home;